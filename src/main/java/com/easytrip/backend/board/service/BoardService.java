...
public interface BoardService {
    ...
    String writePost(BoardRequestDto boardRequestDto, MultipartFile file ) throws Exception;

    String updatePost(Long boardId, BoardRequestDto boardRequestDto, MultipartFile file) throws Exception;
