...
public class BoardController {
    ...
    @PostMapping
    public ResponseEntity<String> writePost(@Valid @RequestBody BoardRequestDto boardRequestDto, MultipartFile file) throws Exception {
        String response = boardService.writePost(boardRequestDto, file);
    ...
    public ResponseEntity<String> updatePost(@Valid @PathVariable(name = "boardId") Long boardId,
                                             @RequestBody BoardRequestDto boardRequestDto, MultipartFile file) throws Exception {

        String response = boardService.updatePost(boardId, boardRequestDto, file);
